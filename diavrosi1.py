...
with col2:
    ...
    # Επεξήγηση Τεχνητής Παραλίας
    if έργο_προστασίας == "Τεχνητή παραλία":
        with st.expander("ℹ️ Τι είναι η Τεχνητή Παραλία;"):
            st.markdown("""
            Η **τεχνητή παραλία** είναι μία παρέμβαση για να **προστατευτεί η ακτή** και να παραμείνει κατάλληλη για αναψυχή.

            **Πώς λειτουργεί:**
            - Μεταφέρουμε **νέα άμμο** για να μεγαλώσει ή να αποκατασταθεί η παραλία
            - Η νέα λωρίδα άμμου **απορροφά την ενέργεια των κυμάτων**
            - Έτσι **μειώνεται η διάβρωση** πίσω από την παραλία

            🏖️ Χρησιμοποιείται συχνά σε τουριστικές περιοχές.

            ❗ Δεν είναι μόνιμη λύση – χρειάζεται **συντήρηση** και **αναπλήρωση** κάθε λίγα χρόνια.
            """)
...
st.subheader("📊 Αποτελέσματα: Υποχώρηση της Ακτής")
